  ...
  <!--CABEÇALHO-->
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                     <a class="navbar-brand" href="inicio.php">Technolosell</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link active" aria-current="page"href="teclados.php">Teclados</a>
                            <div class="container-fluid">
                                <form class="d-flex">
...
<section class="py-5 text-center container">
    <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">TECLADOS</h1>
            <p class="lead text-muted">Descubra as melhores ofertas do mercado de tencologias!</p>
        </div>
    </div>
</section>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      ...
      <div class="col">
        <div class="card shadow-sm">
          <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: IMAGEM" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em">صورة مصغرة</text></svg>
          ...
          <h5>NOME DO PRODUTO</h5>
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
              <a href="compra.php"> <button type="button" class="btn btn-sm btn-outline-secondary">COMPRAR</button></a>
              </div>
